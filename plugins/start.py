...
from bot import Bot
from config import ADMINS, FORCE_MSG, OWNER_ID, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT
...
async def start_command(client: Client, message: Message):
    ...
    [
        ...
        [
            InlineKeyboardButton("Anime", url="https://t.me/Anime_Ryuzen"),
            InlineKeyboardButton("Movies & Series", url="https://t.me/series_movies_paradox")
        ],
        [
